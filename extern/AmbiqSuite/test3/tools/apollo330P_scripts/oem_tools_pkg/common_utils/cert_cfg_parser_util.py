...
def key_cert_config_file_parser(config_fname, log_file):
    ...
    local_dict['auth_key'] = config.get(section_name, 'auth-key')
    log_sync(log_file,"auth-key: " + local_dict['auth_key'] + "\n")

    local_dict['signature_plugin_path'] = config.get(section_name, "signature-plugin-path")
    log_sync(log_file,"signature-plugin-path: " + local_dict['signature_plugin_path'] + "\n")

    local_dict['signature_plugin_cfg'] = config.get(section_name, "signature-plugin-cfg")
    log_sync(log_file,"signature-plugin-cfg: " + local_dict['signature_plugin_cfg'] + "\n")

    local_dict['auth_pubkey'] = config.get(section_name, 'auth-pubkey')
    log_sync(log_file,"auth-pubkey: " + local_dict['auth_pubkey'] + "\n")
