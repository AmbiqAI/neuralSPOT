...
| Type | Name |
| ---: | :--- |
|  wsfBufPoolDesc\_t | [**webbleBufferDescriptors**](#variable-webblebufferdescriptors)   = = {
    {16, 8}, 
    {32, 4},
    {64, 6},
    {512, 14}}<br> |
|  uint32\_t | [**webbleWSFBufferPool**](#variable-webblewsfbufferpool)  <br> |
|  [**ns\_ble\_pool\_config\_t**](structns__ble__pool__config__t.md) | [**webbleWsfBuffers**](#variable-webblewsfbuffers)   = = {
    .pool = webbleWSFBufferPool,
    .poolSize = sizeof(webbleWSFBufferPool),
    .desc = webbleBufferDescriptors,
    .descNum = WEBBLE\_WSF\_BUFFER\_POOLS}<br> |
