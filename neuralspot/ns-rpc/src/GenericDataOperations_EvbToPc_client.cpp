...
// evb_to_pc interface ns_rpc_data_sendBlockToPC function client shim.
status ns_rpc_data_sendBlockToPC(const dataBlock * block)
{
    ...
    {
        codec->startWriteMessage(kInvocationMessage, kevb_to_pc_service_id, kevb_to_pc_ns_rpc_data_sendBlockToPC_id, request.getSequence());
    ...
    g_client->callErrorHandler(err, kevb_to_pc_ns_rpc_data_sendBlockToPC_id);
...
// evb_to_pc interface ns_rpc_data_fetchBlockFromPC function client shim.
status ns_rpc_data_fetchBlockFromPC(dataBlock * block)
{
    ...
    {
        codec->startWriteMessage(kInvocationMessage, kevb_to_pc_service_id, kevb_to_pc_ns_rpc_data_fetchBlockFromPC_id, request.getSequence());
    ...
    // Invoke error handler callback function
    g_client->callErrorHandler(err, kevb_to_pc_ns_rpc_data_fetchBlockFromPC_id);
...
// evb_to_pc interface ns_rpc_data_computeOnPC function client shim.
status ns_rpc_data_computeOnPC(const dataBlock * in_block, dataBlock * result_block)
{
    ...
    {
        codec->startWriteMessage(kInvocationMessage, kevb_to_pc_service_id, kevb_to_pc_ns_rpc_data_computeOnPC_id, request.getSequence());
    ...
    // Invoke error handler callback function
    g_client->callErrorHandler(err, kevb_to_pc_ns_rpc_data_computeOnPC_id);
...
// evb_to_pc interface ns_rpc_data_remotePrintOnPC function client shim.
status ns_rpc_data_remotePrintOnPC(const char * msg)
{
    ...
    {
        codec->startWriteMessage(kInvocationMessage, kevb_to_pc_service_id, kevb_to_pc_ns_rpc_data_remotePrintOnPC_id, request.getSequence());

        codec->writeString(strlen((const char*)msg), (const char*)msg);
    ...
    // Invoke error handler callback function
    g_client->callErrorHandler(err, kevb_to_pc_ns_rpc_data_remotePrintOnPC_id);
