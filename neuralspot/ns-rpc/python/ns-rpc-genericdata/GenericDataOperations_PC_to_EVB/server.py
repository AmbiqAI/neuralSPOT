...
class pc_to_evbService(erpc.server.Service):
    def __init__(self, handler):
        ...
        self._methods = {
                ...
                interface.Ipc_to_evb.NS_RPC_DATA_FETCHBLOCKFROMEVM_ID: self._handle_ns_rpc_data_fetchBlockFromEVM,
    ...
    def _handle_ns_rpc_data_fetchBlockFromEVM(self, sequence, codec):
        ...
        # Invoke user implementation of remote function.
        _result = self._handler.ns_rpc_data_fetchBlockFromEVM(block)
        ...
        codec.start_write_message(erpc.codec.MessageInfo(
            type=erpc.codec.MessageType.kReplyMessage,
            service=interface.Ipc_to_evb.SERVICE_ID,
            request=interface.Ipc_to_evb.NS_RPC_DATA_FETCHBLOCKFROMEVM_ID,
            sequence=sequence))
