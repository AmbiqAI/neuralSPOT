...
ns-ahrs is a sensor fusion algorithm based on the Mahony filter using the scripts found here:
http://davidegironi.blogspot.com/2013/02/avr-atmega-mpu6050-gyroscope-and.html#.VzjDKfnhCUk
**/
...
/**
 * @brief Collect a frame of data and calculate quaternion values. Send those values to be 
