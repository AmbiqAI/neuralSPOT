...
erpc_status_t
evb_to_pc_service::handleInvocation(uint32_t methodId, uint32_t sequence, Codec *codec,
...
erpc_status_t
evb_to_pc_service::ns_rpc_data_sendBlockToPC_shim(Codec *codec,
                                                  MessageBufferFactory *messageFactory,
                                                  uint32_t sequence) {
    ...
    if (err == kErpcStatus_Success) {
        ...
        codec->startWriteMessage(kReplyMessage, kevb_to_pc_service_id,
                                 kevb_to_pc_ns_rpc_data_sendBlockToPC_id, sequence);
...
erpc_status_t
evb_to_pc_service::ns_rpc_data_fetchBlockFromPC_shim(Codec *codec,
                                                     MessageBufferFactory *messageFactory,
                                                     uint32_t sequence) {
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (err == kErpcStatus_Success) {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, kevb_to_pc_service_id,
                                 kevb_to_pc_ns_rpc_data_fetchBlockFromPC_id, sequence);
...
erpc_status_t
evb_to_pc_service::ns_rpc_data_computeOnPC_shim(Codec *codec, MessageBufferFactory *messageFactory,
                                                uint32_t sequence) {
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (err == kErpcStatus_Success) {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, kevb_to_pc_service_id,
                                 kevb_to_pc_ns_rpc_data_computeOnPC_id, sequence);
...
erpc_status_t
evb_to_pc_service::ns_rpc_data_remotePrintOnPC_shim(Codec *codec,
                                                    MessageBufferFactory *messageFactory,
                                                    uint32_t sequence) {
    erpc_status_t err = kErpcStatus_Success;
    ...
    if (err == kErpcStatus_Success) {
        ...
        // Build response message.
        codec->startWriteMessage(kReplyMessage, kevb_to_pc_service_id,
                                 kevb_to_pc_ns_rpc_data_remotePrintOnPC_id, sequence);
