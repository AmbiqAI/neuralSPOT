...
// Fix -Wpedantic "ISO C does not permit named variadic macros" warning
#define metal_err(fmt, ...) metal_log(METAL_LOG_ERROR, fmt, ##__VA_ARGS__)
#define metal_warn(fmt, ...) metal_log(METAL_LOG_WARNING, fmt, ##__VA_ARGS__)
#define metal_info(fmt, ...) metal_log(METAL_LOG_INFO, fmt, ##__VA_ARGS__)
#define metal_dbg(fmt, ...) metal_log(METAL_LOG_DEBUG, fmt, ##__VA_ARGS__)
