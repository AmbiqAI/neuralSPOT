...
#if NS_AD_AOT_FULL_PMU && (defined(AM_PART_APOLLO5B) || defined(AM_PART_APOLLO330P_510L))
...
static NS_SRAM_BSS uint32_t s_accm_store[AOT_MAX_LAYERS * NS_PMU_MAP_ENTRIES];
