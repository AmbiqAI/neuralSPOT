...
from common_cert_lib.contentcertificateconfig import ContentCertificateConfig
from common_cert_lib.contentarmcertificate import ContentArmCertificate

# Adding the utility python scripts to the python PATH
CURRENT_PATH = sys.path[0]
DEFAULT_OUTPUT_DIR_NAME = CURRENT_PATH + '/am_cert_content_util_output/'
