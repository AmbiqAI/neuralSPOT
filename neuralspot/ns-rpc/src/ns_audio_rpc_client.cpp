...
static void
write_nsAudioBuffer_t_struct(erpc::Codec *codec, const nsAudioBuffer_t *data);

//! @brief Function to write struct audioCommand_t
static void
write_audioCommand_t_struct(erpc::Codec *codec, const audioCommand_t *data);
...
nsAudioStatus_e
erpcDumpAudioBuffer(const audioCommand_t *buf) {
    ...
    if (codec == NULL) {
        ...
        codec->startWriteMessage(kInvocationMessage, kns_audio_rpc_service_id,
                                 kns_audio_rpc_erpcDumpAudioBuffer_id, request.getSequence());
