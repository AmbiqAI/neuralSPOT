...
private:
    ...
    erpc_status_t ns_rpc_data_sendBlockToEVB_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);

    /*! @brief Server shim for ns_rpc_data_fetchBlockFromEVB of pc_to_evb interface. */
    erpc_status_t ns_rpc_data_fetchBlockFromEVB_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);

    /*! @brief Server shim for ns_rpc_data_computeOnEVB of pc_to_evb interface. */
    erpc_status_t ns_rpc_data_computeOnEVB_shim(erpc::Codec * codec, erpc::MessageBufferFactory *messageFactory, uint32_t sequence);
};
...
erpc_service_t create_pc_to_evb_service(void);

#if ERPC_ALLOCATION_POLICY == ERPC_ALLOCATION_POLICY_DYNAMIC
void destroy_pc_to_evb_service(erpc_service_t service);
#elif ERPC_ALLOCATION_POLICY == ERPC_ALLOCATION_POLICY_STATIC
void destroy_pc_to_evb_service(void);
#else
