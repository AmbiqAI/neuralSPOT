...
void UnityAssertEqualNumber(
    const UNITY_INT expected, const UNITY_INT actual, const char *msg,
    const UNITY_LINE_TYPE lineNumber, const UNITY_DISPLAY_STYLE_T style);

void UnityAssertEqualIntArray(
    UNITY_INTERNAL_PTR expected, UNITY_INTERNAL_PTR actual, const UNITY_UINT32 num_elements,
    const char *msg, const UNITY_LINE_TYPE lineNumber, const UNITY_DISPLAY_STYLE_T style);

void UnityAssertBits(
    const UNITY_INT mask, const UNITY_INT expected, const UNITY_INT actual, const char *msg,
...
void UnityAssertEqualStringLen(
    const char *expected, const char *actual, const UNITY_UINT32 length, const char *msg,
    const UNITY_LINE_TYPE lineNumber);

void UnityAssertEqualStringArray(
    const char **expected, const char **actual, const UNITY_UINT32 num_elements, const char *msg,
    const UNITY_LINE_TYPE lineNumber);

void UnityAssertEqualMemory(
    UNITY_INTERNAL_PTR expected, UNITY_INTERNAL_PTR actual, const UNITY_UINT32 length,
    const UNITY_UINT32 num_elements, const char *msg, const UNITY_LINE_TYPE lineNumber);

void UnityAssertNumbersWithin(
    const UNITY_UINT delta, const UNITY_INT expected, const UNITY_INT actual, const char *msg,
    const UNITY_LINE_TYPE lineNumber, const UNITY_DISPLAY_STYLE_T style);
...
void UnityAssertFloatsWithin(
    const UNITY_FLOAT delta, const UNITY_FLOAT expected, const UNITY_FLOAT actual, const char *msg,
    const UNITY_LINE_TYPE lineNumber);

void UnityAssertEqualFloatArray(
    UNITY_PTR_ATTRIBUTE const UNITY_FLOAT *expected, UNITY_PTR_ATTRIBUTE const UNITY_FLOAT *actual,
    const UNITY_UINT32 num_elements, const char *msg, const UNITY_LINE_TYPE lineNumber);

void UnityAssertFloatSpecial(
    const UNITY_FLOAT actual, const char *msg, const UNITY_LINE_TYPE lineNumber,
    const UNITY_FLOAT_TRAIT_T style);
#endif

#ifndef UNITY_EXCLUDE_DOUBLE
void UnityAssertDoublesWithin(
    const UNITY_DOUBLE delta, const UNITY_DOUBLE expected, const UNITY_DOUBLE actual,
...
#define UNITY_TEST_ASSERT_EQUAL_INT(expected, actual, line, message)                               \
    UnityAssertEqualNumber(                                                                        \
        (UNITY_INT)(expected), (UNITY_INT)(actual), (message), (UNITY_LINE_TYPE)(line),            \
        UNITY_DISPLAY_STYLE_INT)
#define UNITY_TEST_ASSERT_EQUAL_INT8(expected, actual, line, message)                              \
    UnityAssertEqualNumber(                                                                        \
        (UNITY_INT)(UNITY_INT8)(expected), (UNITY_INT)(UNITY_INT8)(actual), (message),             \
        (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT8)
#define UNITY_TEST_ASSERT_EQUAL_INT16(expected, actual, line, message)                             \
    UnityAssertEqualNumber(                                                                        \
        (UNITY_INT)(UNITY_INT16)(expected), (UNITY_INT)(UNITY_INT16)(actual), (message),           \
        (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_INT16)
#define UNITY_TEST_ASSERT_EQUAL_INT32(expected, actual, line, message)                             \
    UnityAssertEqualNumber(                                                                        \
        (UNITY_INT)(UNITY_INT32)(expected), (UNITY_INT)(UNITY_INT32)(actual), (message),           \
...
#define UNITY_TEST_ASSERT_EQUAL_UINT8(expected, actual, line, message)                             \
    UnityAssertEqualNumber(                                                                        \
        (UNITY_INT)(UNITY_UINT8)(expected), (UNITY_INT)(UNITY_UINT8)(actual), (message),           \
        (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_UINT8)
#define UNITY_TEST_ASSERT_EQUAL_UINT16(expected, actual, line, message)                            \
    UnityAssertEqualNumber(                                                                        \
        (UNITY_INT)(UNITY_UINT16)(expected), (UNITY_INT)(UNITY_UINT16)(actual), (message),         \
        (UNITY_LINE_TYPE)(line), UNITY_DISPLAY_STYLE_UINT16)
#define UNITY_TEST_ASSERT_EQUAL_UINT32(expected, actual, line, message)                            \
    UnityAssertEqualNumber(                                                                        \
        (UNITY_INT)(UNITY_UINT32)(expected), (UNITY_INT)(UNITY_UINT32)(actual), (message),         \
...
#define UNITY_TEST_ASSERT_BITS(mask, expected, actual, line, message)                              \
    UnityAssertBits(                                                                               \
        (UNITY_INT)(mask), (UNITY_INT)(expected), (UNITY_INT)(actual), (message),                  \
        (UNITY_LINE_TYPE)(line))

#define UNITY_TEST_ASSERT_INT_WITHIN(delta, expected, actual, line, message)                       \
    UnityAssertNumbersWithin(                                                                      \
        (delta), (UNITY_INT)(expected), (UNITY_INT)(actual), (message), (UNITY_LINE_TYPE)(line),   \
        UNITY_DISPLAY_STYLE_INT)
#define UNITY_TEST_ASSERT_INT8_WITHIN(delta, expected, actual, line, message)                      \
    UnityAssertNumbersWithin(                                                                      \
        (UNITY_UINT8)(delta), (UNITY_INT)(UNITY_INT8)(expected), (UNITY_INT)(UNITY_INT8)(actual),  \
...
#define UNITY_TEST_ASSERT_EQUAL_STRING_LEN(expected, actual, len, line, message)                   \
    UnityAssertEqualStringLen(                                                                     \
        (const char *)(expected), (const char *)(actual), (UNITY_UINT32)(len), (message),          \
        (UNITY_LINE_TYPE)(line))
#define UNITY_TEST_ASSERT_EQUAL_MEMORY(expected, actual, len, line, message)                       \
    UnityAssertEqualMemory(                                                                        \
        (UNITY_INTERNAL_PTR)(expected), (UNITY_INTERNAL_PTR)(actual), (UNITY_UINT32)(len), 1,      \
...
#define UNITY_TEST_ASSERT_EQUAL_STRING_ARRAY(expected, actual, num_elements, line, message)        \
    UnityAssertEqualStringArray(                                                                   \
        (const char **)(expected), (const char **)(actual), (UNITY_UINT32)(num_elements),          \
        (message), (UNITY_LINE_TYPE)(line))
#define UNITY_TEST_ASSERT_EQUAL_MEMORY_ARRAY(expected, actual, len, num_elements, line, message)   \
    UnityAssertEqualMemory(                                                                        \
        (UNITY_INTERNAL_PTR)(expected), (UNITY_INTERNAL_PTR)(actual), (UNITY_UINT32)(len),         \
        (UNITY_UINT32)(num_elements), (message), (UNITY_LINE_TYPE)(line))
    ...
    #define UNITY_TEST_ASSERT_FLOAT_WITHIN(delta, expected, actual, line, message)                 \
        UnityAssertFloatsWithin(                                                                   \
            (UNITY_FLOAT)(delta), (UNITY_FLOAT)(expected), (UNITY_FLOAT)(actual), (message),       \
            (UNITY_LINE_TYPE)(line))
    #define UNITY_TEST_ASSERT_EQUAL_FLOAT(expected, actual, line, message)                         \
    ...
    #define UNITY_TEST_ASSERT_EQUAL_FLOAT_ARRAY(expected, actual, num_elements, line, message)     \
        UnityAssertEqualFloatArray(                                                                \
            (UNITY_FLOAT *)(expected), (UNITY_FLOAT *)(actual), (UNITY_UINT32)(num_elements),      \
            (message), (UNITY_LINE_TYPE)(line))
    #define UNITY_TEST_ASSERT_FLOAT_IS_INF(actual, line, message)                                  \
    ...
    #define UNITY_TEST_ASSERT_DOUBLE_WITHIN(delta, expected, actual, line, message)                \
        UnityAssertDoublesWithin(                                                                  \
            (UNITY_DOUBLE)(delta), (UNITY_DOUBLE)(expected), (UNITY_DOUBLE)(actual), (message),    \
            (UNITY_LINE_TYPE)line)
    #define UNITY_TEST_ASSERT_EQUAL_DOUBLE(expected, actual, line, message)                        \
    ...
    #define UNITY_TEST_ASSERT_EQUAL_DOUBLE_ARRAY(expected, actual, num_elements, line, message)    \
        UnityAssertEqualDoubleArray(                                                               \
            (UNITY_DOUBLE *)(expected), (UNITY_DOUBLE *)(actual), (UNITY_UINT32)(num_elements),    \
            (message), (UNITY_LINE_TYPE)line)
    #define UNITY_TEST_ASSERT_DOUBLE_IS_INF(actual, line, message)                                 \
