...
alignas(16) static uint8_t var_arena[kVarArenaSize];// Validator Stuff
...
{ 
    FeatureClass_construct(
        ...
        FEATURE_QBIT,
        params_nn3_se.num_mfltrBank,
        params_nn3_se.winsize_stft,
        params_nn3_se.hopsize_stft,
        ...
        int16_t *pcm_output)
{
    ...
    2. melspectrogram
    */
    int dim_input = params_nn3_se.num_mfltrBank;
    ...
    int16_t *ptfeat = FEAT_INST.normFeatContext + dim_input * (FEAT_INST.num_context-1);
