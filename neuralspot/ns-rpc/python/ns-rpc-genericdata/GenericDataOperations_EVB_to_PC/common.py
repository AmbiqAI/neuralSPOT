#GenericDataOperations EVB-to-PC Definition
#/
#/ USe this as the client on the EVB and server on PC

#
# Generated by erpcgen 1.9.1 on Thu Sep  8 16:37:19 2022.
#
...
#GenericDataOperations Common Data Types
class status:
...
class dataBlock(object):
    ...
    def __str__(self):
        return "<%s@%x length=%s dType=%s description=%s cmd=%s buffer=%s>" % (self.__class__.__name__, id(self), self.length, self.dType, self.description, self.cmd, self.buffer)
